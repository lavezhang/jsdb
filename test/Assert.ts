class Assert {
    ...
    public static runCase(caseName: string, caseFn: () => void) {
        try {
            if (caseFn) {
                caseFn();
            }
    ...
    public static isTrue(actual: any) {
        Assert.isEqual(actual, true, false);
    }

    public static isFalse(actual: any) {
        Assert.isEqual(actual, false, false);
    }

    public static isEqual(actual: any, expect: any, ignoreError: boolean = false): boolean {
        if (actual == expect) {
            return true;
        }
        var suc = false;
    ...
    public static toDebugStr(o: any, indent: string = ""): string {
        var s: string = "";
